	...
	if PluginManager.installed?("BW Summary Screen")
		...
		def drawPageThree
			...
			textpos = [
				...
				[sprintf("%d/%d", @pokemon.hp, @pokemon.totalhp), 382, 83, 1, Color.new(255, 255, 255), Color.new(104, 104, 104)],
				...
				[sprintf("%d", @pokemon.attack), 382, 127, 1, Color.new(255, 255, 255), Color.new(104, 104, 104)],
				...
				[sprintf("%d", @pokemon.defense), 382, 159, 1, Color.new(255, 255, 255), Color.new(104, 104, 104)],
				...
				[sprintf("%d", @pokemon.spatk), 382, 191, 1, Color.new(255, 255, 255), Color.new(104, 104, 104)],
				...
				[sprintf("%d", @pokemon.spdef), 382, 223, 1, Color.new(255, 255, 255), Color.new(104, 104, 104)],
				...
				[sprintf("%d", @pokemon.speed), 382, 255, 1, Color.new(255, 255, 255), Color.new(104, 104, 104)],
		...
		if Settings::I_EDITED_MY_SUMMARY
			...
			def drawPageThree
				...
				textpos = [
					...
					[sprintf("%d/%d", @pokemon.hp, @pokemon.totalhp), 462, 82, 1, Color.new(255, 255, 255), Color.new(104, 104, 104)],
					[_INTL("Attack"), 244, 126, 0, base, statshadows[:ATTACK]],
					[sprintf("%d", @pokemon.attack), 456, 126, 1, Color.new(255, 255, 255), Color.new(104, 104, 104)],
					[_INTL("Defense"), 244, 158, 0, base, statshadows[:DEFENSE]],
					[sprintf("%d", @pokemon.defense), 456, 158, 1, Color.new(255, 255, 255), Color.new(104, 104, 104)],
					[_INTL("Sp. Atk"), 244, 190, 0, base, statshadows[:SPECIAL_ATTACK]],
					[sprintf("%d", @pokemon.spatk), 456, 190, 1, Color.new(255, 255, 255), Color.new(104, 104, 104)],
					[_INTL("Sp. Def"), 244, 222, 0, base, statshadows[:SPECIAL_DEFENSE]],
					[sprintf("%d", @pokemon.spdef), 456, 222, 1, Color.new(255, 255, 255), Color.new(104, 104, 104)],
					[_INTL("Speed"), 244, 254, 0, base, statshadows[:SPEED]],
					[sprintf("%d", @pokemon.speed), 456, 254, 1, Color.new(255, 255, 255), Color.new(104, 104, 104)]#, #DemICE edit
					#[_INTL("Ability"), 224, 290, 0, base, shadow]  #DemICE edit
				]		
			...
			def drawPageThree
				...
				textpos = [
					[sprintf("%d", @pokemon.ev[:HP]), 374, 82, 1, Color.new(255, 255, 255), Color.new(106, 106, 106)],
					[sprintf("%d", @pokemon.ev[:ATTACK]), 374, 127, 1, Color.new(255, 255, 255), Color.new(106, 106, 106)],
					[sprintf("%d", @pokemon.ev[:DEFENSE]), 374, 159, 1, Color.new(255, 255, 255), Color.new(106, 106, 106)],
					[sprintf("%d", @pokemon.ev[spatk]), 374, 191, 1, Color.new(255, 255, 255), Color.new(106, 106, 106)],
					[sprintf("%d", @pokemon.ev[:SPECIAL_DEFENSE]), 374, 223, 1, Color.new(255, 255, 255), Color.new(106, 106, 106)],
					[sprintf("%d", @pokemon.ev[:SPEED]), 374, 255, 1, Color.new(255, 255, 255), Color.new(106, 106, 106)]
				]
